...
- **Description**: Track and display products user has viewed
- **What works**: localStorage-based tracking, widget on homepage, tracker on product detail
- **Notes**: Stores up to 10 products, can be extended to database for logged-in users
...
### 13.3.2026
- Added: Recently Viewed Products feature - tracks products users view in localStorage and displays them on homepage (PR #111)
