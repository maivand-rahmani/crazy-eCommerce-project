...
let checkIfCouponValid = (coupon) => {
    const { discount_amount , discount_percent , max_usage , times_used , valid_from , expires_at} = coupon
    ...
    return { type: type , value: type === "amount" ? discount_amount : discount_percent }
}
