...
const Airpodspro = () => {
  return (
    <div className='p-3 w-full h-full flex flex-col md:flex-row center bg-3banner-bg'>
      <Image alt='Airpodspro ' priority width={136} height={190} className='realative ' src={"https://dothqlonkpealipywtrp.supabase.co/storage/v1/object/public/crazy/ProjectPics/hero__gnfk5g59t0qe_xlarge_2x%201%20(1).png"}></Image>
