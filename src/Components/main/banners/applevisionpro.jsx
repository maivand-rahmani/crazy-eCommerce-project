...
const Applevisionpro = async () => {
  ...
  return (
    <div className='p-3 w-full h-full flex flex-col bg-2banner-bg center md:flex-row '>
      <Image alt='Applevisionpro' priority width={190} height={250}  style={{ width: "auto", height: "auto" }}  src={"https://dothqlonkpealipywtrp.supabase.co/storage/v1/object/public/crazy/ProjectPics/image%2036%20(1).png"}></Image>
