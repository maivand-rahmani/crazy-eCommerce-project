...
const Header = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 h-fit w-full z-[9999] bg-white shadow-sm md:top-0">
      <header className="flex items-center justify-between gap-14 p-4 md:justify-center h-22 text-black relative">
        {/* Company logo */}
        <div className="hidden">{<Cyber />}</div>
      ...
      {/* Mobile menu */}
        ...
        {/* <div className="absolute top-full left-0 w-full bg-white z-[9998] border-t transition-all md:hidden">
