...
const Applevisionpro = async () => {
  ...
  return (
    <div className='p-3 w-full h-full flex flex-col bg-banner-4 center md:flex-row '>
      <Image alt='Applevisionpro' priority width={190} height={250}  style={{ width: "auto", height: "auto" }}  src={"https://194.156.118.210/uploads/images/image%2036%20(1).png"}></Image>
