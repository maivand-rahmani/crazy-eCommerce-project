            ...
            <div className="space-y-3">
              <div className="bg-surface rounded-lg p-4 border border-border">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-medium text-unactive-text uppercase tracking-wider">{t("emailAddress")}</p>
                    <p className="text-sm text-text font-mono mt-1">{user.email}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-surface rounded-lg p-4 border border-border">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-medium text-unactive-text uppercase tracking-wider">{t("userId")}</p>
                    <p className="text-sm text-text font-mono mt-1">{user.id}</p>
                  </div>
                </div>
              </div>
              ...
              {user.createdAt && (
                <div className="bg-surface rounded-lg p-4 border border-border">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-medium text-unactive-text uppercase tracking-wider">{t("memberSince")}</p>
                      <p className="text-sm text-text mt-1">{formatDate(user.createdAt)}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {user.updatedAt && (
                <div className="bg-surface rounded-lg p-4 border border-border">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-medium text-unactive-text uppercase tracking-wider">{t("lastUpdated")}</p>
                      <p className="text-sm text-text mt-1">{formatDate(user.updatedAt)}</p>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="space-y-3">
              ...
              {loadingAddresses ? (
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-unactive-text">{address.country}</p>
                          {address.phone && (
                ...
                <div className="text-center py-6 bg-surface rounded-lg border border-dashed border-border">
                  ...
                  <p className="text-sm text-unactive-text">{t("noAddresses")}</p>
                  <button
                    type="button"
                    onClick={() => setIsAddressModalOpen(true)}
